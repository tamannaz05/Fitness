...
app.use("", authRoutes);
app.use("/user", authorize, profile);
app.use("/user/log", authorize, breakfast);
app.use("/user/log", authorize, lunch);
app.use("/user/log", authorize, dinner);
app.use("/user/log", authorize, getlog);
app.use("/user/cal", authorize, getcal);
